...
export const PRO_TYPES: {
  ...
  },
  {
    ...
    brands: [
      ...
      { name: "Chango", src: "/enseignes/chr/chango.png" },
      { name: "Selva", src: "/enseignes/chr/selva.png" },
      { name: "PNY", src: "/enseignes/chr/pny.webp" },
      { name: "Nicky's BBQ", src: "/enseignes/chr/nickys.png" },
      { name: "A Feu Lent", src: "/enseignes/chr/a-feu-lent.jpeg" },
      { name: "Atelier du Braséro", src: "/enseignes/chr/atelier-du-brasero.jpg" },
      { name: "Villa Marthe", src: "/enseignes/chr/villa-marthe.png" },
      // Restaurateurs sans logo dispo — vignettes photo (BBQ Street Food)
