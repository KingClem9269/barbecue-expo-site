  ...
  return (
    <html lang={locale}>
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Albert+Sans:ital,wght@0,100..900;1,100..900&family=Inter+Tight:ital,wght@0,100..900;1,100..900&family=Pinyon+Script&display=swap"
          rel="stylesheet"
        />
      </head>
        <body
