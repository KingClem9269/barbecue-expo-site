...
> = {
  fr: {
    ...
    title: "Les exposants",
    description:
      "250 marques internationales sélectionnées. Barbecues, accessoires, combustibles, sauces, aménagement outdoor, gourmet, spiritueux, restaurateurs — toutes réunies à Paris du 10 au 12 avril 2027.",
  ...
  en: {
    ...
    description:
      "250 curated international brands. Grills, accessories, fuels, sauces, outdoor design, gourmet, spirits, restaurateurs — all gathered in Paris April 10-12, 2027.",
    allCategories: "All",
  ...
  es: {
    ...
    description:
      "250 marcas internacionales seleccionadas. Parrillas, accesorios, combustibles, salsas, diseño exterior, gourmet, licores, restauradores.",
    allCategories: "Todas",
  ...
  de: {
    ...
    description:
      "250 kuratierte internationale Marken. Grills, Zubehör, Brennstoffe, Saucen, Outdoor-Design, Feinkost, Spirituosen, Gastronomen.",
    allCategories: "Alle",
  ...
  nl: {
    ...
    title: "De exposanten",
    description:
      "250 geselecteerde internationale merken. Grills, accessoires, brandstoffen, sauzen, buitendesign, delicatessen, gedistilleerd, restauranthouders.",
    allCategories: "Alle",
  ...
  pt: {
    ...
    description:
      "250 marcas internacionais selecionadas. Grelhas, acessórios, combustíveis, molhos, design exterior, gourmet, destilados, restauradores.",
    allCategories: "Todas",
  ...
  it: {
    ...
    description:
      "250 marchi internazionali selezionati. Griglie, accessori, combustibili, salse, design outdoor, gastronomia, distillati, ristoratori.",
    allCategories: "Tutte",
