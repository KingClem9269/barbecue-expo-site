...
const CONTENT: Record<string, Parameters<typeof EditorialManifesto>[0]> = {
  fr: {
    ...
    reasons: [
      {
        number: "01",
        title: "Voir 250 marques en trois jours.",
        body: "Weber, Traeger, Kamado Joe, OFYR, Big Green Egg, Monolith, Napoleon, Broil King — et 240 autres. C'est le seul endroit en Europe où vous pouvez tout comparer côte à côte, demander des conseils techniques aux concepteurs, tester avant d'acheter. Un trimestre de recherches gagné.",
  ...
  es: {
    ...
    reasons: [
      { number: "01", title: "Ver 250 marcas en tres días.", body: "Weber, Traeger, Kamado Joe, OFYR, Big Green Egg y 245 más. El único lugar de Europa donde se puede comparar todo, pedir consejos técnicos a los diseñadores, probar antes de comprar.", image: "/photos-2026/bbq-expo-184.jpg" },
  ...
  de: {
    ...
    reasons: [
      { number: "01", title: "250 Marken in drei Tagen sehen.", body: "Weber, Traeger, Kamado Joe, OFYR, Big Green Egg und 245 weitere. Der einzige Ort in Europa, an dem Sie alles vergleichen, technische Fragen an die Designer stellen und vor dem Kauf testen können.", image: "/photos-2026/bbq-expo-184.jpg" },
  ...
  nl: {
    ...
    reasons: [
      { number: "01", title: "250 merken in drie dagen zien.", body: "Weber, Traeger, Kamado Joe, OFYR, Big Green Egg en 245 anderen. De enige plek in Europa waar u alles naast elkaar kunt vergelijken, ontwerpers technische vragen kunt stellen, kunt testen voor u koopt.", image: "/photos-2026/bbq-expo-184.jpg" },
  ...
  pt: {
    ...
    reasons: [
      { number: "01", title: "Ver 250 marcas em três dias.", body: "Weber, Traeger, Kamado Joe, OFYR, Big Green Egg e 245 outras. O único lugar na Europa onde se pode comparar lado a lado, fazer perguntas técnicas aos designers, testar antes de comprar.", image: "/photos-2026/bbq-expo-184.jpg" },
  ...
  it: {
    ...
    reasons: [
      { number: "01", title: "Vedere 250 marchi in tre giorni.", body: "Weber, Traeger, Kamado Joe, OFYR, Big Green Egg e altri 245. L'unico posto in Europa dove si può confrontare tutto, fare domande tecniche ai progettisti, provare prima di comprare.", image: "/photos-2026/bbq-expo-184.jpg" },
